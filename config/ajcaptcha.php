...
return [
    ...
    'click_world' => [
        'backgrounds' => [
            //文字验证码背景图
            public_path().'static/ajcaptcha/check1.jpg',
            public_path().'static/ajcaptcha/check2.jpg',
            public_path().'static/ajcaptcha/check3.jpg',
            public_path().'static/ajcaptcha/check4.jpg',
        ],
        'word_num' => 3, //写入多少字文字（2-5）
    ],
    //滑动验证码
    'block_puzzle' => [
