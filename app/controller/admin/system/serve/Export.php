...
class Export extends BaseController
{
    ...
    public function getExportTemp(CrmebServeServices $services)
    {
        ...
        $data['is_shipment'] = merchantConfig($this->request->merId(),'mer_dump_type') ? 0 : 1;
        $data['com'] = $com;
        return app('json')->success($services->express()->expr_dump($data));
    }
