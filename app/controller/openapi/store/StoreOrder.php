...
class StoreOrder extends BaseController
{
     ...
     *
     * @param App $app 应用实例
     * @param StoreOrderRepository $repository 订单仓库实例
     */
    public function __construct(App $app, StoreOrderRepository $repository)
    {
        ...
        // 判断当前请求的开放路由是否包含订单管理权限
        if (!in_array(OpenAuthRepository::AUTH_TYPE_ORDER, $this->request->openRoule())) throw new AuthException('无此权限');
    }
