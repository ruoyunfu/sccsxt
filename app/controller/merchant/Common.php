...
class Common extends BaseController
{
    ...
    public function uploadCertificate()
    {
        ...
        $data = $upload->to('attach')->move('file', false, false);
        if ($data === false) {
    ...
    public function config()
    {
        ...
        $reservation = merchantConfig($this->request->merId(),[ 'enable_assigned', 'enable_checkin', 'checkin_radius',
            'enable_trace', 'trace_form_id', 'enable_tostore_assigned','checkin_take_photo']);
    ...
    public function saveConfig($type)
    {
        switch ($type) {
            case 'reservation':
                $params = ['enable_assigned', 'enable_checkin', 'checkin_radius', 'enable_trace', 'trace_form_id','enable_tostore_assigned','checkin_take_photo'];
                break;
            default:
                $params = [];
                break;
