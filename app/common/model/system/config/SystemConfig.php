...
class SystemConfig extends BaseModel
{
    ...
    {
        return $this->hasOne(SystemConfigClassify::class,'config_classify_id','config_classify_id');
    }

    public function getLinkedDataAttr()
    {
        return [(int)$this->linked_id,(int)$this->linked_value];
    }
