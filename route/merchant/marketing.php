...
Route::group(function () {
    //商品列表， 用于活动筛选的商品信息
    Route::get('product_list', 'merchant.store.product.Product/product_list');

    //秒杀活动
    Route::group('store/seckill/active', function () {
        Route::get('lst', '/list')->name('merchantStoreSeckillActiveGetActiveList')->option([
            '_alias' => '列表',
        ]);
        Route::get('detail/:id', '/detail')->name('merchantStoreSeckillActiveGetActiveInfo')->option([
            '_alias' => '详情',
        ]);
        Route::get('select', '/select')->name('merchantStoreSeckillActiveGetActiveAll')->option([
            '_alias' => '列表',
        ]);
        Route::get('chart_panel/:id', '/chart_panel')->name('merchantStoreSeckillActiveChartPanel')->option([
            '_alias' => '活动统计数据面板',
        ]);
        Route::get('chart_people/:id', '/chart_people')->name('merchantStoreSeckillActiveChartPeople')->option([
            '_alias' => '活动参与人统计列表',
        ]);
        Route::get('chart_order/:id', '/chart_order')->name('merchantStoreSeckillActiveChartOrder')->option([
            '_alias' => '活动订单统计列表',
        ]);
        Route::get('chart_product/:id', '/chart_product')->name('merchantStoreSeckillActiveChartProduct')->option([
            '_alias' => '活动商品统计列表',
        ]);
    })->prefix('merchant.store.seckill.SeckillActive')->option([
    ...
    Route::group('store/seckill_product', function () {
        Route::get('lst', '/get_page_list')->name('merchantStoreSeckillProductPageLst')->option([
            '_alias' => '分页列表',
        ]);
        Route::get('list', '/get_list')->name('merchantStoreSeckillProductLst')->option([
            '_alias' => '列表',
        ]);

        Route::get('product_list', '/get_product_list')->name('merchantStoreSeckillProductGetProductList')->option([
            '_alias' => '商品列表',
        ]);
        ...
        Route::post('labels/:id', '/setLabels')->name('merchantStoreSeckillProductSetLabels')->option([
            '_alias' => '设置标签',
        ]);
    ...
    })->prefix('merchant.store.seckill.SeckillProduct')->option([
        '_path' => '/marketing/seckill/product/list',
        '_auth' => true,
    ]);
    ...
    //秒杀场次
    Route::get('store/seckill/time/lst', 'merchant.store.seckill.SeckillTime/lst');
