...
Route::group(function () {
    ...
    Route::group('user/extract', function () {
        ...
        Route::get('detail/:id', 'UserExtract/detail')->name('systemUserExtractDetail')->option([
            '_alias' => '详情',
        ]);
    ...
    Route::group('bill', function () {
        Route::get('list', '/getList')->name('systemUserBillList')->option([
            '_alias' => '列表',
        ]);
    ...
    Route::group('financial_record', function () {
        Route::get('mer_lst', '/merchantFinancial')->name('systemFinancialRecordMerLst')->option([
            '_alias' => '商户列表',
        ]);
        Route::get('mer_list/:id', '/merAcountsList')->name('systemFinancialRecordMerAcountsLst')->option([
            '_alias' => '商户统计',
        ]);
        Route::get('mer_title/:id', '/merAcountsTitle')->name('systemFinancialRecordMerTitle')->option([
            '_alias' => '商户财务头部统计',
        ]);
        Route::get('mer_detail/:type', '/merDetail')->name('systemFinancialRecordMerDetail')->option([
            '_alias' => '商户财务详情',
        ]);
        Route::get('mer_excel/:type', '/merExportDetail')->name('systemFinancialRecordMerExcel')->option([
            '_alias' => '商户财务导出',
        ]);
    })->prefix('admin.system.merchant.FinancialRecord')->option([
        '_path' => '/accounts/merchantBill',
        '_auth' => true,
    ]);
