...
Route::group(function () {
    ...
    Route::group('order', function () {
        ...
        Route::get('refund/detail/:id', 'RefundOrder/detail')->name('systemRefundOrderDetail')->option([
            '_alias' => '详情',
        ]);
        Route::get('refund/log/:id', 'RefundOrder/log')->name('systemRefundOrderLog')->option([
            '_alias' => '日志',
        ]);
        Route::post('refund/approve/:id', 'RefundOrder/approve')->name('systemRefundOrderApprove')->option([
            '_alias' => '审核',
        ]);
