...
Route::group(function () {
    ...
    Route::group('diy/', function () {
        Route::get('get_product_detail', 'Diy/get_product_detail')->name('systemDiyGetProductDetail')->option([
            '_alias' => '商品详情 ',
        ]);
        Route::post('save_product_detail', 'Diy/save_product_detail')->name('systemDiySaveProductDetail')->option([
            '_alias' => '商品详情保存 ',
        ]);
    ...
    Route::group('diy/', function () {
        Route::get('get_theme_key', 'VisualConfig/getThemeKey')->name('systemVisualStoreGetThemeKey')->option([
            '_alias' => '可视化列表',
        ]);
        Route::get('get_theme/:key', 'VisualConfig/getTheme')->name('systemVisualStoreGetTheme')->option([
            '_alias' => '可视化详情',
        ]);
        Route::post('set_theme/:key', 'VisualConfig/setTheme')->name('systemVisualSetTheme')->option([
            '_alias' => '可视化保存',
        ]);
    })->prefix('admin.system.diy.')->option([
        '_path' => '/setting/system_visualization_data',
        '_auth' => true,
        '_append'=> [
            [
                '_name'  =>'uploadImage',
    ...
    // 悬浮按钮
    Route::group('diy/fab', function () {
        Route::get('info', 'Diy/fabInfo')->name('systemDiyFabInfo')->option([
            '_alias' => '悬浮按钮信息',
        ]);
        Route::post('create/:id', 'Diy/saveData')->name('systemDiyFabSave')->option([
            '_alias' => '保存悬浮按钮',
        ]);
    })->prefix('admin.system.diy.')->option([
        '_path' => '/setting/fab',
    ...
    ])->append(['is_diy' => 3, 'name' => '悬浮按钮', 'title' => '悬浮按钮']);
    // 平台商品分类
    Route::group('diy/productCategory', function () {
        Route::get('info', 'Diy/productCategoryInfo')->name('systemDiyProductCategoryInfo')->option([
            '_alias' => '商品分类信息',
        ]);
        Route::post('create/:id', 'Diy/saveData')->name('systemDiyProductCategorySave')->option([
            '_alias' => '保存商品分类',
        ]);
    })->prefix('admin.system.diy.')->option([
        '_path' => '/setting/product_category',
        '_auth' => true
    ])->append(['is_diy' => 4, 'name' => '平台商品分类', 'title' => '平台商品分类']);
